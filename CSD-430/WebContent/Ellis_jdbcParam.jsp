<%-- Pj Ellis - Module 6 - 6/22/2023 - Database Connecting using Parameters from web.xml file --%>
...
<title>Module 6 - JDBC test using parameters</title>
</head>
<body>
	<% //Connect to database using parameters in the web.xml file
